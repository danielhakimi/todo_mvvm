...
extension UIView {
    ...
    open func centerInSuperview(size: CGSize = .zero, paddingY: CGFloat = 0) {
        translatesAutoresizingMaskIntoConstraints = false
        ...
        if let superviewCenterYAnchor = superview?.centerYAnchor {
            centerYAnchor.constraint(equalTo: superviewCenterYAnchor, constant: paddingY).isActive = true
        }
